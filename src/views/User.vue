...
<div>
  ...
  <div style="margin: 10px 0">
    <el-input style="width: 200px" placeholder="请输入用户名" suffix-icon="el-icon-s-custom" v-model="username"></el-input>
    <el-input style="width: 200px" placeholder="请输入邮箱" suffix-icon="el-icon-ship" v-model="email" class="ml-5"></el-input>
    <el-input style="width: 200px" placeholder="请输入地址" suffix-icon="el-icon-s-cooperation" v-model="address" class="ml-5"></el-input>
  ...
  <div style="margin: 10px 0">
    ...
    <el-popconfirm
        ...
        @confirm="delBatch"
    >
      <el-button type="danger" slot="reference">批量删除<i class="el-icon-lollipop"></i></el-button>
    </el-popconfirm>
  ...
  <el-table :data="tableData" border stripe header-cell-class-name="headerBg"  @selection-change="handleSelectionChange">
    ...
    <el-table-column label="操作" align="center">
      <template slot-scope="scope">   <!--数据放在scope里 下面用scope传数据-->
        ...
        >
          <el-button type="danger" slot="reference">删除<i class="el-icon-ice-cream-round"></i></el-button>
        </el-popconfirm>
      </template>
    </el-table-column>
  </el-table>
